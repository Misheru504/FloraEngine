...
class FastNoise
{
    ...
    private FastNoise(nint nodeHandle)
    {
    ...
    {
        nint nodeHandle = fnNewFromEncodedNodeTree(encodedNodeTree);
    ...
    {
        if (noiseOut.LongLength != xSize * ySize) throw new ArgumentOutOfRangeException("noiseOut isn't the same size as xSize * ySize!");
    ...
    private nint mNodeHandle = nint.Zero;

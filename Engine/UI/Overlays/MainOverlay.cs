...
internal class MainOverlay : IImGuiOverlay
{
    ...
    public void Draw(double deltaTime)
    {
        ...
        if (ImGui.Begin("Overlay", ImGuiWindowFlags.NoBringToFrontOnFocus | ImGuiWindowFlags.AlwaysAutoResize | ImGuiWindowFlags.NoTitleBar | ImGuiWindowFlags.NoMove))
        {
            ...
            Vector3 voxelPos = PlayerController.LocalVoxelPos;

            Vector3 reconstructedPos = PlayerController.ChunkPos + voxelPos;
            ...
            ImGui.Text($"Camera speed: {PlayerController.Instance.Speed:F2}");
            ...
            ImGui.Spacing();
            ImGui.Text($"Chunk pos: {PlayerController.ChunkPos:0}");
